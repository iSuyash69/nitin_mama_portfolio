    ...
    return(
        <div className={`h-full w-full relative overflow-hidden transition-all select-none  ease-in-out flex flex-col ${darkMode ? 'text-white' : 'text-black' } `}>
            ...
            <div className="w-full gap-[12%] w-md:gap-[9%] ipad:gap-[10%] px-[18%] w-md:px-[12%] ipad:px-[14%] flex justify-center mt-6 w-md:mt-4 h-full">
                ...
                <form onSubmit={handleSubmit} className="flex flex-col pt-2 w-md:pt-1">
                    ...
                    <div className="flex relative w-[350px] mb-6 w-md:mb-4">                    
                    ...
                    <div className="relative w-[350px] mb-6 w-md:mb-4">
                    ...
                    <div className="flex w-full mt-6 w-md:mt-5 justify-center">
                        <button type="submit" className={`interactive py-2.5 transition-all rounded-md ease-in-out px-7 font-bold text-[15px] ${darkMode?'bg-white text-black':'bg-black text-white'}`}>Connect</button>
                    </div>
                </form>
            </div>
